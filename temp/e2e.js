...
describe("application launch", () => {
  beforeEach(_utils__WEBPACK_IMPORTED_MODULE_1__["default"].beforeEach);
  afterEach(_utils__WEBPACK_IMPORTED_MODULE_1__["default"].afterEach);
  it("shows hello world text on screen after launch", function () {
    return this.app.client.getText("#greet").then(text => {
      Object(chai__WEBPACK_IMPORTED_MODULE_0__["expect"])(text).to.equal("Hello World!");
    });
  });
});
